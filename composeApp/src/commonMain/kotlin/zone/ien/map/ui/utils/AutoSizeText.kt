...
import zone.ien.map.ui.theme.getPretendard
import zone.ien.map.ui.utils.SuggestedFontSizesStatus.Companion.rememberSuggestedFontSizesStatus
...
fun AutoSizeText(
    ...
    fontFamily: FontFamily? = getPretendard(),
