...
import map.composeapp.generated.resources.tooltip_description
import map.composeapp.generated.resources.tooltip_label
...
private fun MyWrappedAnchor(
    ...
    val scope = rememberCoroutineScope()
    val longPressLabel = stringResource(Res.string.tooltip_label)
...
private fun MyTooltipPopup(
    ...
    val tooltipDescription = stringResource(Res.string.tooltip_description)
    Popup(
