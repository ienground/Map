...
class IosLocationManager: NSObject(), CLLocationManagerDelegateProtocol {
    ...
    suspend fun requestLocationPermission(): LocationPermissionStatus = suspendCancellableCoroutine { continuation ->
        ...
        when (CLLocationManager.authorizationStatus()) {
            ...
            kCLAuthorizationStatusRestricted, kCLAuthorizationStatusDenied -> continuation.resume(LocationPermissionStatus.RESTRICTED_OR_DENIED)
            kCLAuthorizationStatusAuthorizedWhenInUse, kCLAuthorizationStatusAuthorizedAlways -> continuation.resume(LocationPermissionStatus.ACCEPTED)
        }
    }
